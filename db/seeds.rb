...
video25 = Video.create!({ title: "Chop Vegetables", category_id: category4.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
