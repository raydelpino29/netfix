...
video12 = Video.create!({ title: "Pest Removal", category_id: category2.id, description: "This video demonstrates how to enage in techniques that will prevent and remove pests."})
video13 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video14 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video15 = Video.create!({ title: "Pest Removal", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
...
video17 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video18 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video19 = Video.create!({ title: "Pest Removal", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
...
video21 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video22 = Video.create!({ title: "Chop Vegetables", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
video23 = Video.create!({ title: "Pest Removal", category_id: category3.id, description: "This video demonstrates how to make a tasty vegetable mixture, which will add flavor to your food." })
